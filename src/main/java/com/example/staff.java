		...
		try (Scanner scanner = new Scanner(System.in)) {
			...
			try {
				...
				if (line == null) {
					...
					fileOut.println("<h1 class='m-5'>Liste des employees</h1>");
					fileOut.println("<div class='container m-5'>");
					fileOut.println("<div class='row'>");
					fileOut.println("<a  class='list-group-item list-group-item-action list-group-item-primary'  href='c.bertier.html'>");
